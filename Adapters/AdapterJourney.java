...
public class AdapterJourney extends RecyclerView.Adapter<AdapterJourney.ListViewHolder>{
    ...
    public static class ListViewHolder extends RecyclerView.ViewHolder {
        ...
        public ListViewHolder(@NonNull View itemView, final OnItemClickListener listener) {
            super(itemView);
            txtName = itemView.findViewById(R.id.itemTitle);
            txtDate = itemView.findViewById(R.id.itemContent);
    ...
    public AdapterJourney(ArrayList<Journey> exampleList){
        arrayList = exampleList;
    }

    @Override
    public ListViewHolder onCreateViewHolder(ViewGroup parent, int i) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_journey, parent, false);
